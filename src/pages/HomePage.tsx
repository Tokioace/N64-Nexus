...
const HomePage: React.FC = () => {
  ...
  const fanArtItems: FanArtItem[] = [
    { id: '1', title: 'Mario in Peach\'s Castle', artist: 'PixelArtist64', imageUrl: 'https://via.placeholder.com/200x150/FF6B6B/FFFFFF?text=Mario+Art', likes: 234, views: 1250, game: 'Super Mario 64' },
    { id: '2', title: 'Link vs Ganondorf Epic Battle', artist: 'ZeldaDrawer', imageUrl: 'https://via.placeholder.com/200x150/4ECDC4/FFFFFF?text=Zelda+Art', likes: 189, views: 980, game: 'Ocarina of Time' },
    { id: '3', title: 'Banjo & Kazooie Adventure', artist: 'RetroSketch', imageUrl: 'https://via.placeholder.com/200x150/45B7D1/FFFFFF?text=Banjo+Art', likes: 156, views: 750, game: 'Banjo-Kazooie' },
    { id: '4', title: 'Rainbow Road Nostalgia', artist: 'KartArtist', imageUrl: 'https://via.placeholder.com/200x150/96CEB4/FFFFFF?text=Kart+Art', likes: 298, views: 1400, game: 'Mario Kart 64' },
    { id: '5', title: 'GoldenEye 007 Facility Map', artist: 'SpyArtist', imageUrl: 'https://via.placeholder.com/200x150/FFEAA7/000000?text=GoldenEye+Art', likes: 167, views: 890, game: 'GoldenEye 007' },
    { id: '6', title: 'Diddy Kong Racing Team', artist: 'RareArtFan', imageUrl: 'https://via.placeholder.com/200x150/DDA0DD/FFFFFF?text=Diddy+Art', likes: 134, views: 620, game: 'Diddy Kong Racing' },
    { id: '7', title: 'Star Fox 64 Arwing Squadron', artist: 'SpaceArtist', imageUrl: 'https://via.placeholder.com/200x150/74B9FF/FFFFFF?text=StarFox+Art', likes: 201, views: 1100, game: 'Star Fox 64' },
    { id: '8', title: 'Smash Bros N64 All Stars', artist: 'FighterArt', imageUrl: 'https://via.placeholder.com/200x150/FD79A8/FFFFFF?text=Smash+Art', likes: 345, views: 1800, game: 'Super Smash Bros' },
    { id: '9', title: 'Yoshi\'s Story Cute Style', artist: 'YoshiLover', imageUrl: 'https://via.placeholder.com/200x150/00B894/FFFFFF?text=Yoshi+Art', likes: 123, views: 560, game: 'Yoshi\'s Story' },
    { id: '10', title: 'F-Zero X Speed Demon', artist: 'RacingArt64', imageUrl: 'https://via.placeholder.com/200x150/E17055/FFFFFF?text=F-Zero+Art', likes: 178, views: 820, game: 'F-Zero X' }
  ]

  const mediaItems: MediaItem[] = [
    { id: '1', title: 'Mario 64 16 Star WR Run', uploader: 'SpeedDemon64', type: 'video', thumbnailUrl: 'https://via.placeholder.com/200x150/FF6B6B/FFFFFF?text=Mario+Video', uploadDate: new Date(Date.now() - 3600000), views: 5430 },
    { id: '2', title: 'OoT Any% New PB!', uploader: 'ZeldaRunner', type: 'video', thumbnailUrl: 'https://via.placeholder.com/200x150/4ECDC4/FFFFFF?text=Zelda+Video', uploadDate: new Date(Date.now() - 7200000), views: 3210 },
    { id: '3', title: 'Perfect Dark Agent Speedrun', uploader: 'SecretRunner', type: 'video', thumbnailUrl: 'https://via.placeholder.com/200x150/2D3436/FFFFFF?text=PerfectDark+Video', uploadDate: new Date(Date.now() - 10800000), views: 2890 },
    { id: '4', title: 'Mario Kart 64 Epic Comeback', uploader: 'KartMaster', type: 'screenshot', thumbnailUrl: 'https://via.placeholder.com/200x150/96CEB4/FFFFFF?text=Kart+Screenshot', uploadDate: new Date(Date.now() - 14400000), views: 1560 },
    { id: '5', title: 'Live: GoldenEye Tournament', uploader: 'EventStream', type: 'stream', thumbnailUrl: 'https://via.placeholder.com/200x150/FFEAA7/000000?text=GoldenEye+Stream', uploadDate: new Date(Date.now() - 18000000), views: 8920 },
    { id: '6', title: 'Banjo-Kazooie 100% Completion', uploader: 'BearRunner', type: 'video', thumbnailUrl: 'https://via.placeholder.com/200x150/45B7D1/FFFFFF?text=Banjo+Video', uploadDate: new Date(Date.now() - 21600000), views: 4560 },
    { id: '7', title: 'Smash Bros Combo Video', uploader: 'ComboKing', type: 'video', thumbnailUrl: 'https://via.placeholder.com/200x150/FD79A8/FFFFFF?text=Smash+Video', uploadDate: new Date(Date.now() - 25200000), views: 6780 },
    { id: '8', title: 'Star Fox 64 Expert Mode', uploader: 'StarPilot', type: 'video', thumbnailUrl: 'https://via.placeholder.com/200x150/74B9FF/FFFFFF?text=StarFox+Video', uploadDate: new Date(Date.now() - 28800000), views: 2340 },
    { id: '9', title: 'Paper Mario Glitchless Run', uploader: 'PaperSpeedster', type: 'video', thumbnailUrl: 'https://via.placeholder.com/200x150/FDCB6E/000000?text=Paper+Mario', uploadDate: new Date(Date.now() - 32400000), views: 3450 },
    { id: '10', title: 'Diddy Kong Racing Screenshot', uploader: 'RacingFan', type: 'screenshot', thumbnailUrl: 'https://via.placeholder.com/200x150/DDA0DD/FFFFFF?text=Diddy+Screenshot', uploadDate: new Date(Date.now() - 36000000), views: 1230 }
  ]
  ...
  const marketplaceItems: MarketplaceItem[] = [
    { id: '1', title: 'Super Mario 64 - Mint Condition', price: 89.99, currency: 'EUR', seller: 'RetroCollector', condition: 'Mint', imageUrl: 'https://via.placeholder.com/200x150/FF6B6B/FFFFFF?text=Mario+64', createdAt: new Date(Date.now() - 3600000) },
    { id: '2', title: 'N64 Controller - Original Nintendo', price: 34.50, currency: 'EUR', seller: 'ControllerKing', condition: 'Very Good', imageUrl: 'https://via.placeholder.com/200x150/636E72/FFFFFF?text=N64+Controller', createdAt: new Date(Date.now() - 7200000) },
    { id: '3', title: 'GoldenEye 007 - Complete in Box', price: 125.00, currency: 'EUR', seller: 'GameVault', condition: 'Good', imageUrl: 'https://via.placeholder.com/200x150/FFEAA7/000000?text=GoldenEye+007', createdAt: new Date(Date.now() - 10800000) },
    { id: '4', title: 'Ocarina of Time - Gold Cartridge', price: 199.99, currency: 'EUR', seller: 'ZeldaFanatic', condition: 'Mint', imageUrl: 'https://via.placeholder.com/200x150/FDCB6E/000000?text=Zelda+Gold', createdAt: new Date(Date.now() - 14400000) },
    { id: '5', title: 'N64 Console - Jungle Green', price: 149.99, currency: 'EUR', seller: 'ConsoleDealer', condition: 'Very Good', imageUrl: 'https://via.placeholder.com/200x150/00B894/FFFFFF?text=N64+Console', createdAt: new Date(Date.now() - 18000000) },
    { id: '6', title: 'Mario Kart 64 - Player\'s Choice', price: 45.00, currency: 'EUR', seller: 'KartCollector', condition: 'Good', imageUrl: 'https://via.placeholder.com/200x150/96CEB4/FFFFFF?text=Mario+Kart', createdAt: new Date(Date.now() - 21600000) },
    { id: '7', title: 'Perfect Dark - Big Box Edition', price: 89.50, currency: 'EUR', seller: 'RareGameHunter', condition: 'Very Good', imageUrl: 'https://via.placeholder.com/200x150/2D3436/FFFFFF?text=Perfect+Dark', createdAt: new Date(Date.now() - 25200000) },
    { id: '8', title: 'Banjo-Kazooie - Manual included', price: 67.99, currency: 'EUR', seller: 'ManualMaster', condition: 'Good', imageUrl: 'https://via.placeholder.com/200x150/45B7D1/FFFFFF?text=Banjo+Kazooie', createdAt: new Date(Date.now() - 28800000) },
    { id: '9', title: 'Star Fox 64 - Rumble Pak Bundle', price: 78.00, currency: 'EUR', seller: 'BundleBargains', condition: 'Very Good', imageUrl: 'https://via.placeholder.com/200x150/74B9FF/FFFFFF?text=Star+Fox+64', createdAt: new Date(Date.now() - 32400000) },
    { id: '10', title: 'Super Smash Bros - Tournament Ed.', price: 156.99, currency: 'EUR', seller: 'TournamentGames', condition: 'Mint', imageUrl: 'https://via.placeholder.com/200x150/FD79A8/FFFFFF?text=Smash+Bros', createdAt: new Date(Date.now() - 36000000) }
  ]
