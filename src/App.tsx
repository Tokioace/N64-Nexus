...
import { CartbitProvider, useCartbit, CartbitTooltip, useProfiChallenge } from './components/Cartbit';
import './App.css';

// Demo game component to showcase Cartbit functionality
const Battle64Demo: React.FC = () => {
  ...
  const handleAction = (action: string) => {
    switch (action) {
      ...
      case 'collect':
        setGameState(prev => ({ ...prev, hasWeapon: true }));
        addMessage({
          type: 'success',
      ...
      case 'levelup':
        ...
        addMessage({
          type: 'success',
          message: `Level ${gameState.level + 1} erreicht!`,
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 text-white p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white/10 rounded-lg p-4 text-center">
            <div className="text-2xl font-bold">{gameState.health}</div>
