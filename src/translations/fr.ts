const fr = {
  ...
  'events.joinEvent': 'Rejoindre événement',
  'events.leaveEvent': 'Quitter événement',
  ...
  'error.goHome': 'Aller accueil',
  'error.contactSupport': 'Contacter le support',
  'error.somethingWentWrong': 'Quelque chose a mal tourné',
}
