const de = {
  ...
  'account.deletion.placeholder': 'LÖSCHEN',
  ...
  'validation.contentTooLong': 'Inhalt ist zu lang',  'ui.login': 'Anmelden',
  ...
  'common.hide': 'Verbergen',  'ui.grid': 'Raster',
  'ui.list': 'Liste',
  ...
  'label.notes': 'Notizen',  'validation.contentRequired': 'Inhalt ist erforderlich',
  ...
  // Professional translations - final batch  'events.timeFormat': 'Format: Stunden:Minuten:Sekunden',
  'events.selectDocumentation': 'Nachweis auswählen',
  'events.photo': 'Foto',
  'events.video': 'Video',
  'events.livestreamUrlLabel': 'Livestream-URL',  'events.streamingPlatforms': 'Streaming-Plattformen',  'events.status.upcoming': 'Bevorstehend',
  ...
  'label.region': 'Region',  'news.noNewsAvailable': 'Keine Nachrichten verfügbar',
  ...
  'upload.video': 'Lade ein Video deines Rennens hoch',
  'upload.screenshot': 'Lade einen Screenshot deiner Endzeit hoch',
  'cookies.showDetails': 'Details anzeigen',
  'cookies.hideDetails': 'Details ausblenden',
  'records.pendingCount': '{count} ausstehend',
  'records.verifiedCount': '{count} verifizierte Rekorde',
  'records.userRecords': '{username}s Rekorde',
  'records.myRecords': 'Meine Rekorde',
  'marketplace.goldeneye.description': 'Komplettes Spiel mit Verpackung, Anleitung und Kassette',
  'marketplace.goldeneye.title': 'GoldenEye 007 - Komplett in Originalverpackung',
  'marketplace.mario64.description': 'Original-Kassette in neuwertiger Verfassung mit Anleitung',
  'marketplace.mario64.title': 'Super Mario 64 - Neuwertiger Zustand',
  'fanart.banjo.adventure': 'Banjo & Kazooie Abenteuer',
  'fanart.zelda.battle': 'Link vs Ganondorf Epischer Kampf',
  'fanart.mario.castle': 'Mario in Peachs Schloss',
  'forum.untitledThread': 'Unbenannter Thread',
  'error.invalidDataFormat': 'Ungültiges Datenformat',
