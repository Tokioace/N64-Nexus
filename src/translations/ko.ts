const ko = {
  ...
  'map.description': '설명',
  'map.descriptionPlaceholder': '프로젝터 준비됨, 컨트롤러를 가져오세요!',
  'map.date': '날짜',
  'map.time': '시간',
  'map.region': '지역/도시',
  'map.regionPlaceholder': '서울',
  'map.postalCode': '우편번호',
  'map.postalCodePlaceholder': '04524',
  'map.maxPlayers': '최대 플레이어',
  'map.players': '플레이어',
  'map.privacy': '개인정보',
  'map.publicEvent': '공개 이벤트',
  'map.privateEvent': '비공개 이벤트 (초대 코드)',
  'map.inviteCodePlaceholder': '초대 코드 입력',
  'map.createEvent': '이벤트 만들기',
  'map.worldMap': '세계 지도',
  'map.activeEvents': '활성 이벤트',
  'map.upcomingEvents': '다가오는 이벤트',
  'map.activeUsers': '활성 사용자',
  'map.yourLocation': '내 위치',
  'map.nearbyEvents': '근처 이벤트 (30km)',
  'map.noNearbyEvents': '근처 이벤트를 찾을 수 없습니다',
  'map.globalStats': '글로벌 통계',
  'map.totalUsers': '총 사용자',
  'map.totalEvents': '총 이벤트',
  'map.eventDetails': '이벤트 세부정보',
  'map.hostedBy': '주최자',
  'map.joinEvent': '이벤트 참가',
  'map.countryDetails': '국가 세부정보',
  'map.countryForum': '국가 포럼',
  'map.welcome': 'Battle64 Map에 오신 것을 환영합니다',
  'map.welcomeDescription': '당신의 지역에서 실제 N64 배틀을 발견하고 참가하세요!',
  'map.clickCountry': '국가를 클릭하여 지역 커뮤니티 보기',
  'map.viewEvents': '다가오는 이벤트와 토너먼트 보기',
  'map.hostYourOwn': '자신만의 로컬 배틀 주최하기',
  'map.allEvents': '모든 이벤트',
  'map.noEvents': '이벤트를 찾을 수 없습니다',
  'map.filters': '필터',
  'map.game': '게임',
  'map.allGames': '모든 게임',
  'map.distance': '거리',
  'map.noLimit': '제한 없음',
  'map.locationRequired': '이벤트 참가를 위해 위치 접근이 필요합니다',
  ...
  'auth.exploreEvents': '이벤트 탐색',
  'auth.invalidConfirmationLink': '잘못된 확인 링크',
  'auth.confirmationLinkExpired': '이메일 확인에 실패했습니다. 링크가 만료되었을 수 있습니다.',
  'auth.emailConfirmationFailed': '이메일 확인 실패',
  ...
  'legal.birthDateRequired': '생년월일은 필수입니다',
  'legal.mustBe18': 'Battle64를 사용하려면 18세 이상이어야 합니다',
  'legal.ageConfirmation': '저는 18세 이상이며 서비스 약관에 동의합니다',
  'legal.ageConfirmationRequired': '연령 확인은 필수입니다',
  'legal.termsOfService': '서비스 약관',
  'legal.privacyPolicy': '개인정보 처리방침',
  'legal.termsAcceptance': '서비스 약관에 동의합니다',
  'legal.privacyAcceptance': '개인정보 처리방침에 동의합니다',
  'legal.copyrightAcknowledgment': '업로드하는 콘텐츠에 대한 권리를 소유하고 있으며 저작권을 침해하지 않음을 확인합니다',
  'legal.allAgreementsRequired': '모든 법적 동의가 필요합니다',
  'legal.nintendoDisclaimer': 'Battle64는 닌텐도와 관련이 없습니다. 언급된 모든 상표는 해당 소유자의 자산입니다.',
  ...
  'terms.section1.content': '계정을 만들고 Battle64를 사용함으로써 본 서비스 약관에 동의하게 됩니다. 동의하지 않으시면 저희 플랫폼을 사용할 수 없습니다.',
  'terms.section2.title': '2. 연령 요건',
  'terms.section2.content': 'Battle64는 18세 이상의 사용자만을 대상으로 합니다. 가입함으로써 최소 18세임을 확인하는 것입니다.',
  'terms.section3.title': '3. 사용자 책임',
  'terms.section3.content': 'Battle64 사용은 본인의 책임하에 이루어집니다. 업로드하는 모든 콘텐츠와 다른 사용자와의 모든 상호작용에 대해 책임을 집니다.',
  'terms.section4.title': '4. 만남 및 상호작용',
  'terms.section4.content': '사용자 간의 실제 만남과 상호작용은 Battle64의 책임 범위를 벗어납니다. 낯선 사람과 만날 때는 주의하시기 바랍니다.',
  'terms.section5.title': '5. 콘텐츠 책임',
  'terms.section5.content': '사용자는 업로드한 콘텐츠에 대해 책임을 집니다. Battle64는 사용자 생성 콘텐츠에 대해 책임지지 않습니다.',
  'terms.section6.title': '6. 금지된 콘텐츠',
  'terms.section6.content': '금지된 콘텐츠에는 폭력, 나체, 혐오 발언, 불법 자료 및 저작권 침해가 포함됩니다. 위반 시 계정이 정지됩니다.',
  'terms.section7.title': '7. 닌텐도 저작권',
  ...
  'privacy.section1.title': '1. 수집하는 데이터',
  'privacy.section1.content': '서비스 제공을 위해 프로필 데이터, 이벤트, 스피드런, 미디어 업로드 및 사용 분석을 저장합니다.',
  'privacy.section2.title': '2. 데이터 저장',
  'privacy.section2.content': '데이터는 미국과 EU에 서버를 둔 Supabase를 통해 저장됩니다. 귀하의 데이터는 암호화되어 안전합니다.',
  'privacy.section3.title': '3. 데이터 공유',
  'privacy.section3.content': '법적으로 요구되는 경우를 제외하고 개인 데이터를 제3자와 공유하지 않습니다.',
  'privacy.section4.title': '4. 쿠키',
  'privacy.section4.content': '기능성을 위한 필수 쿠키와 귀하의 동의하에 분석을 위한 선택적 쿠키를 사용합니다.',
  'privacy.section5.title': '5. 귀하의 권리 (GDPR)',
  'privacy.section5.content': '데이터에 대한 접근, 수정 및 삭제 권리가 있습니다. 언제든지 계정을 삭제할 수 있습니다.',
  'privacy.section6.title': '6. 데이터 보존',
  ...
  'cookies.necessary': '필수 쿠키',
  'cookies.necessaryDescription': '웹사이트 기본 기능에 필요',
  'cookies.analytics': '분석 쿠키',
  'cookies.analyticsDescription': '사이트 사용 방식 이해에 도움',
  'cookies.marketing': '마케팅 쿠키',
  'cookies.marketingDescription': '관련 광고 표시에 사용',
  'cookies.preferences': '환경설정 쿠키',
  'cookies.preferencesDescription': '설정과 기본 설정을 기억',
  ...
  'report.title': '콘텐츠 신고',
  'report.reason': '신고 사유',
  'report.description': '설명 (선택사항)',
  'report.reasons.spam': '스팸',
  'report.reasons.inappropriate': '부적절한 콘텐츠',
  'report.reasons.harassment': '괴롭힘',
  'report.reasons.copyright': '저작권 침해',
  'report.reasons.nsfw': 'NSFW 콘텐츠',
  'report.reasons.hate': '혐오 발언',
  ...
  'admin.reports': '신고',
  'admin.pendingReports': '대기 중인 신고',
  'admin.reviewedReports': '검토된 신고',
  'admin.reportDetails': '신고 세부사항',
  'admin.reportedBy': '신고자',
  'admin.reportedAt': '신고 시간',
  'admin.contentType': '콘텐츠 유형',
  'admin.reviewReport': '신고 검토',
  'admin.dismissReport': '신고 기각',
  'admin.takeAction': '조치 취하기',
  'admin.hideContent': '콘텐츠 숨기기',
  'admin.removeContent': '콘텐츠 삭제',
  'admin.warnUser': '사용자 경고',
  'admin.suspendUser': '사용자 정지',
  ...
  'upload.copyrightWarning': '허가 없이 저작권으로 보호된 콘텐츠를 업로드하면 계정 정지로 이어질 수 있습니다',
  'upload.contentWarning': '콘텐츠 경고',
