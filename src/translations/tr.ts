const tr = {
  ...
  'Power Star Collector': 'Güç Yıldızı Toplayıcısı',
  'Castle Conqueror': 'Kale Fatihi',
  'Mushroom Kingdom Elite': 'Mantar Krallığı Eliti',
  'Galaxy Guardian': 'Galaksi Koruyucusu',
  'Time Trial Master': 'Zaman Denemesi Ustası',
  'Warp Zone Warrior': 'Warp Bölgesi Savaşçısı',
