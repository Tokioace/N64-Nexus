const ar = {
  ...
  'Power Star Collector': 'جامع النجوم القوية',
  'Castle Conqueror': 'فاتح القلاع',
  'Mushroom Kingdom Elite': 'نخبة مملكة الفطر',
  'Galaxy Guardian': 'حارس المجرة',
  'Time Trial Master': 'سيد التجارب الزمنية',
  'Warp Zone Warrior': 'محارب منطقة الانتقال',
