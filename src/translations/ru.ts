const ru = {
  ...
  'Power Star Collector': 'Коллекционер Звёзд',
  'Castle Conqueror': 'Завоеватель Замков',
  'Mushroom Kingdom Elite': 'Элита Грибного Королевства',
  'Galaxy Guardian': 'Страж Галактики',
  'Time Trial Master': 'Мастер Гонок на Время',
  'Warp Zone Warrior': 'Воин Зоны Варпа',
