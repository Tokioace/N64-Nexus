const el = {
  ...
  'Power Star Collector': 'Συλλέκτης Αστεριών Δύναμης',
  'Castle Conqueror': 'Κατακτητής Κάστρων',
  'Mushroom Kingdom Elite': 'Ελίτ του Βασιλείου Μανιταριών',
  'Galaxy Guardian': 'Φύλακας Γαλαξία',
  'Time Trial Master': 'Δάσκαλος Χρονικών Δοκιμών',
  'Warp Zone Warrior': 'Πολεμιστής Ζώνης Μεταφοράς',
