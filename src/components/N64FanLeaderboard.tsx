...
const N64FanLeaderboard: React.FC<N64FanLeaderboardProps> = ({ 
          ...
          {leaderboard.slice(0, 5).map((entry) => (
            <div
              ...
              className={`flex items-center justify-between p-2 rounded-lg border transition-all ${
                getPositionBg(entry.position, entry.isCurrentUser)
              }`}
            >
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-slate-300">
                {user.points?.totalPoints.toLocaleString()} {t('points.total')}
              </span>
            </div>
          </div>
        </div>
      ...
      {/* Season Info */}
      <div className="simple-tile bg-gradient-to-r from-purple-500/10 to-pink-500/10 border-purple-400/30">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 text-sm text-slate-300">
            ...
            <span>{leaderboard.length} {t('leaderboard.topPlayers')}</span>
          </div>
        </div>
      </div>
    </div>
